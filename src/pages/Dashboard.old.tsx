...
import { MetaAdsFilters, type FilterValues } from "@/components/meta-ads/MetaAdsFiltersV2";
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="space-y-6 mt-8">
        <div className="border-t border-border pt-8">
          <h2 className="text-2xl font-bold text-foreground mb-6">Meta Ads - Análise Detalhada</h2>

          {/* Filters */}
          <MetaAdsFilters filters={metaFilters} onFiltersChange={setMetaFilters} />

          {/* KPI Cards */}
          <div className="mt-6">
            <MetaAdsKPICards summary={metaSummary} isLoading={summaryMetaLoading} />
          </div>
          ...
          {/* Detailed Metrics */}
          <div className="mt-6">
            <MetaAdsDetailedMetrics summary={metaSummary} isLoading={summaryMetaLoading} />
          </div>
        </div>
      </div>
    </div>
