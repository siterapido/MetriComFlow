-- Migration: Update get_ad_set_metrics to include link_clicks and post_engagement
-- Date: 2025-12-15
...
COMMENT ON FUNCTION get_ad_set_metrics IS 'Retorna métricas agregadas por ad set, incluindo link_clicks e post_engagement, com filtros opcionais por account/campaign/ad_set e período.';
