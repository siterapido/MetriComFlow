-- Migration: Add organization_id to ad_sets and ads tables
-- Description: Adiciona organization_id às tabelas ad_sets e ads para melhorar performance
-- e simplificar queries. Preenche retroativamente usando dados de ad_campaigns.
...
-- Preencher organization_id retroativamente a partir de ad_campaigns
...
-- Preencher organization_id retroativamente a partir de ad_sets -> ad_campaigns
UPDATE public.ads
SET organization_id = ac.organization_id
